 ...
 ***************************************************************/
// DomainTimeView.h: interface for the DomainTimeView class.

#pragma once

class FieldTimeInterval;

class _export DomainTimeView : public GeneralFormView  
{
public:
	DomainTimeView();
	virtual ~DomainTimeView();
...
private:
  ...
  RadioGroup *rgTime;
  DECLARE_DYNCREATE(DomainTimeView)
};
