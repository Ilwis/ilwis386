...
#ifndef GeoRefSubMapCornersView_H
#define GeoRefSubMapCornersView_H
...
class IMPEXP GeoRefSubMapCornersView : public GeoRefGeneratedView
{
public:
	GeoRefSubMapCornersView();
	virtual ~GeoRefSubMapCornersView();

	DECLARE_DYNCREATE(GeoRefSubMapCornersView)
...
#endif GeoRefSubMapCornersView_H
