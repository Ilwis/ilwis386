...
{
        CFont* fntOld = pDC->SelectObject(m_pBoldFont);
...
int CTabWnd::DrawTab(CDC *pDC, int x, LPCTSTR szText)
{
        ...
        pDC->SelectObject(penOld);
        penOld = pDC->SelectObject(&penDGray);
