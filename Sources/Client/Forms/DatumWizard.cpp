	...
	cdp(0), fUpdateDatum(false), fScaleAndRotationFirst(false)
{
	...
	ppSelectPointMaps->SetMenHelpTopic(htpDatumParmsInput);
	ppSelectPointMaps->create();
	AddPage(ppSelectPointMaps);

	// which method to choose
	ppSelectMethod = new SelectMethodPage(this);
	ppSelectMethod->SetMenHelpTopic(htpDatumParmsMethod);
	...
	ppUpdateDatum->SetMenHelpTopic(htpDatumParmsOutput);
