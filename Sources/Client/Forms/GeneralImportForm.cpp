...
void GeneralImportForm::AddOldStyleIlwisImports() {
	...
	ifm.ext = "dbf";
	ifm.method = "IlwisTable";
	ifm.shortName = "DBF";
	ifm.name = "dBase IV File Format";
	ifm.type = ImportFormat::ifTable;
	ifm.useasSuported = true;
	ifm.ui = new AsciiTableWizard(wnd());
	id.formats.push_back(ifm);

	ifm.ext = "tbl";
	ifm.method = "IlwisTable";
	ifm.shortName = "Ilwis 1.4";
	ifm.name = "Ilwis 1.4 File Format";
	ifm.type = ImportFormat::ifTable;
	ifm.useasSuported = false;
	ifm.ui = NULL;
	id.formats.push_back(ifm);
	...
	ifm.ext = "*";
	ifm.method = "IlwisTable";
	ifm.shortName = "Space delimited";
	ifm.name = "Space delimited";
	ifm.type = ImportFormat::ifTable;
	ifm.useasSuported = false;
	ifm.ui = new AsciiTableWizard(wnd());;
	id.formats.push_back(ifm);
	...
	ifm.ext = "*";
	ifm.method = "IlwisTable";
	ifm.shortName = "Fixed format";
	ifm.name = "Fixed format";
	ifm.type = ImportFormat::ifTable;
	ifm.useasSuported = false;
	ifm.ui = new AsciiTableWizard(wnd());
	id.formats.push_back(ifm);
