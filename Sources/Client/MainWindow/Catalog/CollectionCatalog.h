...
class IMPEXP CollectionCatalog : public Catalog
{
public:
	~CollectionCatalog();

protected:
	CollectionCatalog();           // protected constructor used by dynamic creation
	void OnAddObject();
	...
	void AddFile(const FileName &fn, ObjectCollectionDoc *doc);

	DECLARE_DYNCREATE(CollectionCatalog);
