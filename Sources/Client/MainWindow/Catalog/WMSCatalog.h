...
class IMPEXP WMSCatalog : public CollectionCatalog
{
public:
	~WMSCatalog();

	ObjectCollectionDoc* GetDocument();

protected:
	WMSCatalog();           // protected constructor used by dynamic creation
	void OnAddObject();
