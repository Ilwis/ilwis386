 ...
 ***************************************************************/
#ifndef ForeignCatalog_H
#define ForeignCatalog_H
...
class ObjectLister;
class ForeignCollectionDoc;

class IMPEXP ForeignCatalog : public CollectionCatalog
{
public:
	~ForeignCatalog();

	ForeignCollectionDoc* GetDocument();

protected:
	ForeignCatalog();           // protected constructor used by dynamic creation
	void OnAddObject();
//	void OnUpdateAddObject(CCmdUI* pCmdUI);
	...
	DECLARE_DYNCREATE(ForeignCatalog);
