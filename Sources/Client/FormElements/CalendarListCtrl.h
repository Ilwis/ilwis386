...
// Copyright (c) 2001
//
// This is a companion control for use by the CalendarCtrl.
...
/////////////////////////////////////////////////////////////////////////////
// CalendarCtrlListCtrl window

class CalendarCtrlListCtrl : public CWnd
{
// Construction
public:
	CalendarCtrlListCtrl();
...
public:
	...
	void SetCalendar(CalendarCtrl* pWnd);
	...
	CalendarCtrlFontInfo& GetFont() {return m_FontInfo;}

// Overrides
	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(CalendarCtrlListCtrl)
	//}}AFX_VIRTUAL
...
protected:
	...
	CalendarCtrlFontInfo	m_FontInfo;
	CalendarCtrl*			m_pwndCalendar;
