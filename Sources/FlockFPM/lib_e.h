...
char swap_tmp_char;
char *swap_tmp_pointer_c;
long *swap_tmp_pointer_l;
int *swap_tmp_pointer_i;
...
#define SWAP_PNTC(a,b)  (swap_tmp_pointer_c=(char *)a,a=b,b=swap_tmp_pointer_c)
#define SWAP_PNTL(a,b)  (swap_tmp_pointer_l=(long *)a,a=b,b=swap_tmp_pointer_l)
#define SWAP_PNTI(a,b)  (swap_tmp_pointer_i=(int *)a,a=b,b=swap_tmp_pointer_i)
...
#define ARY_CELL(a,b,c) ((a *)((char*)((b).h)+((b).unit*c)))
