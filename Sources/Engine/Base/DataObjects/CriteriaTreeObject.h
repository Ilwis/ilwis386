 ...
 ***************************************************************/
#ifndef ILW_CRITERIA_TREE_OBJECT_H
#define ILW_CRITERIA_TREE_OBJECT_H

#pragma warning( disable : 4786 )

class _export CriteriaTreeObjectPtr: public IlwisObjectPtr
{
public:
	CriteriaTreeObjectPtr(); 
	CriteriaTreeObjectPtr(const ElementContainer& ec);
	String sType() const;
	void Store();
...
public:
	CriteriaTreeObject() ;
	CriteriaTreeObject(const ElementContainer& ec) ;
	CriteriaTreeObject(const CriteriaTreeObject& cto);

private:
	static IlwisObjectPtrList listCriteriaTreeObject;
};
