...
public:
	enum InterfaceFunctions{ifGetAppInfo,ifInit,ifGetAppInfoUI,ifInitUI, ifDrawers,getFFInfo, getImpDrivers, getOptionsUI, getFFInit, getOptionsUIInit};
	enum ModuleInterface{mi36,mi37};
