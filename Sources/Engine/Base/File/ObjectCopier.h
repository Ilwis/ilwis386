...
public:
	...
	ObjectCopier(const FileName& fnFile, const Directory& _dirDestination );
	ObjectCopier(const FileName& fnFile, const FileName& _fnDestination );
	...
	void Copy(bool fBreakDependencies);
