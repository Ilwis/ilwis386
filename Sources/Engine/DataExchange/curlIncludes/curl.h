...
#include "Engine\DataExchange\curlIncludes\curlver.h" /* the libcurl version defines */
...
#include "Engine\DataExchange\curlIncludes\easy.h" /* nothing in curl is fun without the easy stuff */
#include "Engine\DataExchange\curlIncludes\multi.h"
