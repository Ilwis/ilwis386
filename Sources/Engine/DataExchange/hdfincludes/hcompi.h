...
#include "Engine\DataExchange\hdfincludes\hfile.h"
...
#include "Engine\DataExchange\hdfincludes\mstdio.h"     /* stdio modeling header */
...
#include "Engine\DataExchange\hdfincludes\cnone.h"  /* no encoding header */
#include "Engine\DataExchange\hdfincludes\crle.h"   /* run-length encoding header */
#include "Engine\DataExchange\hdfincludes\cnbit.h"  /* N-bit encoding header */
#include "Engine\DataExchange\hdfincludes\cskphuff.h"   /* Skipping huffman encoding header */
#include "Engine\DataExchange\hdfincludes\cdeflate.h"   /* gzip 'deflate' encoding header */
