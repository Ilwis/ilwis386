...
#include "Engine\DataExchange\hdfincludes\hdfi.h"
#include "Engine\DataExchange\hdfincludes\hlimits.h"
...
#include "Engine\DataExchange\hdfincludes\hntdefs.h"

/* Include the Tag definitions */
#include "Engine\DataExchange\hdfincludes\htags.h"
...
#include "Engine\DataExchange\hdfincludes\hbitio.h"
#include "Engine\DataExchange\hdfincludes\hcomp.h"
#include "Engine\DataExchange\hdfincludes\herr.h"
#include "Engine\DataExchange\hdfincludes\hproto.h"
#include "Engine\DataExchange\hdfincludes\vg.h"         /* Add the Vgroup/Vdata header so the users don't have to */
#include "Engine\DataExchange\hdfincludes\mfgr.h"       /* Add the GR header so the users don't have to */

/* For Pablo Instrumentation */
#ifdef HAVE_PABLO
#include "ProcIDs.h"
#include "Engine\DataExchange\hdfincludes\trace.h"
#endif /* PABLO */
