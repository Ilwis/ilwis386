...
/* required includes */
#include "Engine\DataExchange\hdfincludes\hfile.h"  /* special info stuff */

#ifdef   _HCHUNKS_MAIN_
/* Private to 'hchunks.c' */

#include "Engine\DataExchange\hdfincludes\tbbt.h"   /* TBBT stuff */
#include "mcache.h" /* caching routines */
#include "Engine\DataExchange\hdfincludes\hcomp.h"  /* For Compression */
