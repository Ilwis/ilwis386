 ...
 ***************************************************************/
#ifndef ILWTABLEILWIS20_H
#define ILWTABLEILWIS20_H

class TableIlwis20 : public ForeignFormat
{
public:
	_export TableIlwis20();
	_export TableIlwis20(const FileName& fnForeign, ForeignFormat::mtMapType _mtType = mtTable);
