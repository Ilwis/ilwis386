...
namespace ILWIS {
	...
	public:
		...
		enum SpecialDrawingOptions{sdoNone=0, sdoExtrusion=1, sdoSymbolLineNode=2, sdoYMarker=4, sdoFilledPlain=8, sdoSELECTED=16, sdoTOCHILDEREN=32, sdoFootPrint=64, sdoOpen=128, sdoUseLabels=256, sdoFilledShaded=512};
