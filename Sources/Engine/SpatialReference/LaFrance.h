...
#ifndef ILWPRJLaFrance_H
#define ILWPRJLaFrance_H
#include "Engine\SpatialReference\LCONCON.H"

class DATEXPORT ProjectionLaFrance: public ProjectionLambConfConic
{
public:
  ProjectionLaFrance(const Ellipsoid&);
