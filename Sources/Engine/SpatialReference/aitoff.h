...
*/
#ifndef ILWPRJAITOFF_H
#define ILWPRJAITOFF_H

#include "Engine\SpatialReference\prj.h"
class DATEXPORT ProjectionAitoff: public ProjectionPtr
{
friend class _export ProjectionWinkel3;
public:
  ProjectionAitoff();
