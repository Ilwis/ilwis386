...
ProjectionMercatorScaled::ProjectionMercatorScaled(const Ellipsoid& ell)
: ProjectionPtr(ell)
{
  fEll = true;
...
XY ProjectionMercatorScaled::xyConv(const PhiLam& pl) const
{
  XY xy;
...
PhiLam ProjectionMercatorScaled::plConv(const XY& xy) const
{
  PhiLam pl;
/*  
...
void ProjectionMercatorScaled::Param(ProjectionParamValue pv, double rValue)
{
