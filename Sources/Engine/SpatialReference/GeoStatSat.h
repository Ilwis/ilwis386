...
public:
  ...
  virtual PhiLam plConv(const XY&) const;
	...
	bool XYboxToQuadrangle(double xMin, double xMax,
							double yMin, double yMax,
							double& latMin, double& latMax,
							double& lonMin, double& lonMax) const; 
	bool QuadrangleToXYbox	(double latMin, double latMax,
							double lonMin, double lonMax,
							double& xMin, double& xMax,
							double& yMin, double& yMax) const;
	XY xyConvAux(const PhiLam& _pl) const;
	PhiLam plConvAux(const XY&) const;
