 ...
 ***************************************************************/
/*
// $Log: /ILWIS 3.0/ApplicationForms/frmSegmentMapDifference.h $
 * 
 ...
 * Added a field to enter the domain prefix for SegmentMapDifference operations for
...
// Added sNewDom with AreaNumbering and SegmentMapDifference
//
...
class _export FormSegmentMapDifference: public FormSegmentMapCreate
{
public:
	FormSegmentMapDifference(CWnd* mw, const char* sPar);
protected:
