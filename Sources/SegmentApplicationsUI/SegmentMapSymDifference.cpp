...
: FormSegmentMapCreate(mw, TR("Create a symetric difference map of Segments"))
{
	...
	//SetAppHelpTopic(htpGenMapSegmentMapSymetricDifferenceion);
	create();
}

FormEntry *FormSegmentMapSymetricDifferenceion::CheckData() {
	return NULL;
}

int FormSegmentMapSymetricDifferenceion::exec()
{
