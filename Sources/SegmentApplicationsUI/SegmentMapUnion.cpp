 ...
 ***************************************************************/
/*
// $Log: /ILWIS 3.0/ApplicationForms/frmSegmentMapUnionion.cpp $
 * 
 ...
 * Always a DomainSegmentMapUnionion will be used
 * 
 ...
 * Added a field to enter the domain prefix for SegmentMapUnionion operations for
...
// Added sNewDom with AreaNumbering and SegmentMapUnionion
//
...
: FormSegmentMapCreate(mw, SAFTilteSegmentMapUnion)
{
	...
	//SetAppHelpTopic(htpGenMapSegmentMapUnionion);
	create();
}

FormEntry *FormSegmentMapUnionion::CheckData() {
	return NULL;
}

int FormSegmentMapUnionion::exec()
{
