 ...
 ***************************************************************/
/*
// $Log: /ILWIS 3.0/ApplicationForms/frmPolygonMapIntersection.cpp $
 * 
 ...
 * Always a DomainPolygonMapIntersection will be used
 * 
 ...
 * Added a field to enter the domain prefix for PolygonMapIntersection operations for
...
// Added sNewDom with AreaNumbering and PolygonMapIntersection
//
...
: FormPolygonMapCreate(mw, TR("Create a Intersection map of Polygons"))
{
	...
	//SetAppHelpTopic(htpGenMapPolygonMapIntersection);
	create();
}

FormEntry *FormPolygonMapIntersection::CheckData() {
	return NULL;
}

int FormPolygonMapIntersection::exec()
{
	FormPolygonMapCreate::exec();
	FileName fnMap1(sInMap1);
	FileName fnMap2(sInMap2);
	String sExpr = String("PolygonMapIntersect(%S,%S)", fnMap1.sRelativeQuoted(), fnMap2.sRelativeQuoted());
