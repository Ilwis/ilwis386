 ...
 ***************************************************************/
/*
// $Log: /ILWIS 3.0/ApplicationForms/frmPolygonMaprelateion.h $
 * 
 ...
 * Added a field to enter the domain prefix for PolygonMaprelateion operations for
...
// Added sNewDom with AreaNumbering and PolygonMaprelateion
//
...
class _export FormPolygonMapRelate: public FormPolygonMapCreate
{
public:
	FormPolygonMapRelate(CWnd* mw, const char* sPar);
protected:
