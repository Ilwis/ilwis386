 ...
 ***************************************************************/
/*
// $Log: /ILWIS 3.0/ApplicationForms/frmPolygonMapDifference.h $
 * 
 ...
 * Added a field to enter the domain prefix for PolygonMapDifference operations for
...
// Added sNewDom with AreaNumbering and PolygonMapDifference
//
...
class _export FormPolygonMapDifference: public FormPolygonMapCreate
{
public:
	FormPolygonMapDifference(CWnd* mw, const char* sPar);
protected:
