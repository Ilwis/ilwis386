 ...
 ***************************************************************/
/*
// $Log: /ILWIS 3.0/ApplicationForms/frmPolygonMapBuffer.h $
 * 
...
class _export FormPolygonMapBuffer: public FormPolygonMapCreate
{
public:
	FormPolygonMapBuffer(CWnd* mw, const char* sPar);
protected:
