 ...
 ***************************************************************/
/*
// $Log: /ILWIS 3.0/ApplicationForms/frmPolygonMapUnionion.cpp $
 * 
 ...
 * Always a DomainPolygonMapUnionion will be used
 * 
...
: FormPolygonMapCreate(mw, TR("Create a Union map of Polygons"))
{
	...
	//SetAppHelpTopic(htpGenMapPolygonMapUnionion);
	create();
}

FormEntry *FormPolygonMapUnionion::CheckData() {
	return NULL;
}

int FormPolygonMapUnionion::exec()
{
	FormPolygonMapCreate::exec();
	FileName fnMap1(sInMap1);
	FileName fnMap2(sInMap2);
	String sExpr = String("PolygonMapUnion(%S,%S)", fnMap1.sRelativeQuoted(), fnMap2.sRelativeQuoted());
