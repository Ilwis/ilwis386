 ...
 ***************************************************************/
/*
// $Log: /ILWIS 3.0/ApplicationForms/frmPolygonMapIntersection.h $
 * 
...
class _export FormPolygonMapIntersection: public FormPolygonMapCreate
{
public:
	FormPolygonMapIntersection(CWnd* mw, const char* sPar);
protected:
