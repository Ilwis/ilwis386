 ...
 ***************************************************************/
/*
// $Log: /ILWIS 3.0/ApplicationForms/frmPolygonMapConvexHull.h $
 * 
...
class _export FormPolygonMapConvexHull: public FormPolygonMapCreate
{
public:
	FormPolygonMapConvexHull(CWnd* mw, const char* sPar);
protected:
