 ...
 ***************************************************************/
/* $Log: /ILWIS 3.0/ApplicationForms/frmmapap.h $
 * 
 * 25    7/18/06 11:17a Lichun
 * added new operation for generating effect distance map
 * 
 * 24    24-10-03 16:46 Willem
 ...
 * 
 * 23    18-09-02 19:00 Hendrikse
 * added bool fSphericalDistance; to FormMapRasterize
 * inserted new FormMapGriddingWeighted using this flag.
 * and common parent of FormMapMovingAverage and FormMapMovingSurface
 * added DistanceMethodCallBack and corresp Checkbox
 * 
 * 22    25-02-02 12:06 Hendrikse
 ...
 * 
 * 21    1-10-01 17:58 Koolhoven
 * FormMapSubMap: for fldMap use FieldDataType instead of FieldMap
 * 
 * 20    28-08-01 11:43 Koolhoven
 * FormRasterize got a member bmap to store in the callback the input map,
 * to prevent too often constructing one
 * 
 * 19    15-08-01 18:31 Koolhoven
 * added option to specify a GeoRef for MapGlue
 * 
 * 18    8-08-01 9:48 Koolhoven
 * adaptions to allow start with maplist as first parameter
 * 
 * 17    7-08-01 19:47 Koolhoven
 * FormResampleMap: added mp member 
 * 
 * 16    6/21/01 10:58a Martin
 * added support for giving the rowcol/coord infor to a submap form
 * together with the filename
 * 
 * 15    9-11-00 19:05 Hendrikse
 * added #include "Applications\Raster\MAPITPCN.H"  to allow call to
 * vrDefault from FormInterpolMap::MapCallBack(Event*)
 * 
 * 14    10-10-00 11:26 Koolhoven
 * reorganizedFormMapCoKriging, thrown away unsed parts
 * 
 * 13    21-09-00 10:03 Hendrikse
 * added members int MapCallBack(Event*); to various Kriging forms to make
 * a better default value range of output based on input
 * 
 * 12    28/08/00 16:14 Willem
 * Made sure that all raster application forms pass map boundaries to
 * create georef form
 * 
 * 11    25/08/00 17:34 Willem
 ...
 * 
 * 10    10-08-00 15:13 Koolhoven
 * FormMapVariogramSurface no longer asks seprately about the attribute
 * column
 * 
 * 9     16-06-00 13:05 Koolhoven
 * no longer ask for output domain in AreaNumbering 
 * 
 * 8     21-02-00 16:53 Hendrikse
 * FormMapKrigingFromRaster is now derived from FormRasterize.
 * redundant member sMap removed
 * 
 * 7     31-01-00 12:52 Hendrikse
 * added 3 callbacks and members for Unit choice
 * 
 * 6     27-01-00 10:00 Hendrikse
 * added  class _export FormMapKrigingFromRaster
 * 
 ...
 * Added 2.22 stuff
// Revision 1.7  1998/09/16 17:32:28  Wim
// 22beta2
//
// Revision 1.6  1997/09/03 09:49:03  Wim
// Added radiobuttons in FormDensifyMap
//
// Revision 1.5  1997-08-26 14:55:00+02  Wim
// Added sNewDom with AreaNumbering and UniqueID
//
// Revision 1.4  1997-08-22 15:51:22+02  Wim
// FormMapGlue added callbacks
//
// Revision 1.3  1997-08-20 21:24:49+02  Wim
// Changed FormMapAggregate
//
// Revision 1.2  1997-07-30 17:01:01+02  Wim
// Added sNewDom option in FormMapGlue
//
/* FormMapApplications
   Copyright Ilwis System Development ITC
   november 1995, by Wim Koolhoven
	Last change:  WK    6 Jul 98    6:31 pm
*/
#ifndef FRMMAPAP_H
#define FRMMAPAP_H
