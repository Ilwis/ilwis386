 ...
 ***************************************************************/
/*
// $Log: /ILWIS 3.0/ApplicationForms/frmUniqueId.h $
 * 
...
*/
#ifndef FRMGENMAPAP_H
#define FRMGENMAPAP_H
...
class _export FormUniqueID: public FormGeneralMapCreate
{
public:
	FormUniqueID(CWnd* mw, const char* sPar);
protected:
	// make Doxygen happy
private:  
	int exec();
