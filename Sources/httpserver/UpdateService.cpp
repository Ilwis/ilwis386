...
//----------------------------------------------------
UpdateService::UpdateService(struct mg_connection *c, const struct mg_request_info *ri, const map<String, String>& _kvps)
: RequestHandler(c,ri,_kvps), rtype(rtNONE)
{
}
