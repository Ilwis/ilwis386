 ...
 ***************************************************************/
/*
// $Log: /ILWIS 3.0/ApplicationForms/frmPointMapTripleCollocation.h $
 * 
...
class _export FormPointMapTripleCollocation: public FormPointMapCreate
{
public:
	FormPointMapTripleCollocation(CWnd* mw, const char* sPar);
protected:
