 ...
 ***************************************************************/
/*
// $Log: /ILWIS 3.0/ApplicationForms/frmPointMapCross.h $
 * 
 ...
 * Added a field to enter the domain prefix for PointMapCross operations for
...
// Added sNewDom with AreaNumbering and PointMapCross
//
...
LRESULT Cmdpointmapcross(CWnd *wnd, const String& s);

class _export FormPointMapCross: public FormPointMapCreate
{
public:
	FormPointMapCross(CWnd* mw, const char* sPar);
protected:
