 ...
 ***************************************************************/
/*
// $Log: /ILWIS 3.0/ApplicationForms/frmPointMapDifference.h $
 * 
 ...
 * Added a field to enter the domain prefix for PointMapDifference operations for
...
// Added sNewDom with AreaNumbering and PointMapDifference
//
...
class _export FormPointMapDifference: public FormPointMapCreate
{
public:
	FormPointMapDifference(CWnd* mw, const char* sPar);
protected:
