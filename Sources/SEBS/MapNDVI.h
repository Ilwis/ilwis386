 ...
 ***************************************************************/
// MapNDVI.h: interface for the MapNDVI class.
//
//////////////////////////////////////////////////////////////////////
/* MapSEBS model
...
class MapEmissivity : public MapFromMap  
{
friend MapFromMap;
public:
	...
	static MapEmissivity* create(const FileName& fn, MapPtr& p, const String& sExpr);
	virtual bool fDomainChangeable() const;
	virtual bool fGeoRefChangeable() const;

	virtual void Store();
	MapEmissivity(const FileName& fn, MapPtr& p);
	
	MapEmissivity(const FileName& fn, 
				 MapPtr& p,
				 const Map& mpRed,
				 const Map& mpNIR,
				 String sAlbedoMap,
